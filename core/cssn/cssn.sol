...
contract CSSNToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "CSSN";
    string  public constant symbol = "CSSN";
    ...
    uint256 public tokenExchangeRate = 200000;             // 625 CSSN 兑换 1 ETH
